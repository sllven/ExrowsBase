...
# Специальный мини-сервер для обхода ограничений Render
...
# ТВОЙ РАБОЧИЙ ТОКЕН С СЕРВЕРА
BOT_TOKEN = '7864811802:AAH9E0CscS9R771Yp-iRzIn9-oZ17Lw8H9Q'
...
async def cmd_start(message: types.Message):
    if message.chat.type == "private":
        # ЗДЕСЬ ТЫ МОЖЕШЬ ИЗМЕНИТЬ ПРИВЕТСТВЕННЫЙ ТЕКСТ НА ЛЮБОЙ СВОЙ:
        start_text = (
